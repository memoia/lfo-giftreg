...
DATABASES = {
    'default': {
        ...
        'NAME': SITE_PATH + "/private/giftreg.db",                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'lns*4wmyyma$qg#8do0&ou9!lhpox9phx%7cqap34u%r)gjcr@'
